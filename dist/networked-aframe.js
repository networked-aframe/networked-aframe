...
var templateString = _dereq_('es6-template-strings');
...
},{"es6-template-strings":39}],3:[function(_dereq_,module,exports){
'use strict';
...
},{"es5-ext/object/assign":18,"es5-ext/object/is-callable":21,"es5-ext/object/normalize-options":25,"es5-ext/string/#/contains":29}],4:[function(_dereq_,module,exports){
...
},{"../../function/is-arguments":10,"../../function/is-function":11,"../../number/to-pos-integer":17,"../../object/valid-callable":27,"../../object/valid-value":28,"../../string/is-string":32,"es6-symbol":33}],10:[function(_dereq_,module,exports){
'use strict';
...
},{"./noop":12}],12:[function(_dereq_,module,exports){
'use strict';
...
},{"../math/sign":13}],17:[function(_dereq_,module,exports){
'use strict';
...
},{"./to-integer":16}],18:[function(_dereq_,module,exports){
'use strict';
...
},{"../keys":22,"../valid-value":28}],21:[function(_dereq_,module,exports){
// Deprecated
...
},{"./is-implemented":23,"./shim":24}],23:[function(_dereq_,module,exports){
'use strict';
...
},{"./is-implemented":34,"./polyfill":36}],34:[function(_dereq_,module,exports){
'use strict';
...
},{"./validate-symbol":37,"d":3}],37:[function(_dereq_,module,exports){
'use strict';
...
},{"./is-symbol":35}],38:[function(_dereq_,module,exports){
'use strict';

var esniff = _dereq_('esniff')
...
},{"esniff":43}],39:[function(_dereq_,module,exports){
'use strict';

var compile = _dereq_('./compile')
  , resolve = _dereq_('./resolve-to-string');

module.exports = function (template, context/*, options*/) {
	return resolve(compile(template), context, arguments[2]);
};

},{"./compile":38,"./resolve-to-string":41}],40:[function(_dereq_,module,exports){
'use strict';
...
var resolve  = _dereq_('./resolve')
  , passthru = _dereq_('./passthru');

module.exports = function (data, context/*, options*/) {
	return passthru.apply(null, resolve(data, context, arguments[2]));
};

},{"./passthru":40,"./resolve":42}],42:[function(_dereq_,module,exports){
'use strict';

var value          = _dereq_('es5-ext/object/valid-value')
  , normalize      = _dereq_('es5-ext/object/normalize-options')
  , isVarNameValid = _dereq_('esniff/is-var-name-valid')
...
},{"es5-ext/object/normalize-options":25,"es5-ext/object/valid-value":28,"esniff/is-var-name-valid":44}],43:[function(_dereq_,module,exports){
'use strict';

var from         = _dereq_('es5-ext/array/from')
  ...
  , d            = _dereq_('d')
  , eolSet       = _dereq_('./lib/ws-eol')
  , wsSet        = _dereq_('./lib/ws')
...
},{"./lib/ws":47,"./lib/ws-eol":45,"d":48,"es5-ext/array/from":7,"es5-ext/object/primitive-set":26,"es5-ext/object/valid-callable":27,"es5-ext/object/valid-value":28}],44:[function(_dereq_,module,exports){
...
},{"es5-ext/array/from":7,"es5-ext/object/primitive-set":26}],46:[function(_dereq_,module,exports){
'use strict';
...
},{"es5-ext/array/from":7,"es5-ext/object/primitive-set":26}],47:[function(_dereq_,module,exports){
'use strict';

var primitiveSet = _dereq_('es5-ext/object/primitive-set')
  , eol          = _dereq_('./ws-eol')
  , inline       = _dereq_('./ws-inline');

module.exports = primitiveSet.apply(null,
	Object.keys(eol).concat(Object.keys(inline)));

},{"./ws-eol":45,"./ws-inline":46,"es5-ext/object/primitive-set":26}],48:[function(_dereq_,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"dup":3,"es5-ext/object/assign":18,"es5-ext/object/is-callable":21,"es5-ext/object/normalize-options":25,"es5-ext/string/#/contains":29}],49:[function(_dereq_,module,exports){
var globals = {
  appId: '',
  roomId: '',
  debug: false,
...
window.naf = naf;
module.exports = naf;
},{"./NafGlobals.js":49,"./NafLogger.js":52,"./NafUtil.js":53}],51:[function(_dereq_,module,exports){
class NafInterface {
  notImplemented() {
...
},{"./NafIndex.js":50,"./webrtc_interfaces/WebRtcInterface.js":61}],55:[function(_dereq_,module,exports){
var naf = _dereq_('./NafIndex.js');
...
},{"./NafIndex.js":50}],56:[function(_dereq_,module,exports){
...
},{"../NafIndex.js":50,"deep-equal":4}],58:[function(_dereq_,module,exports){
var naf = _dereq_('../NafIndex.js');
...
},{"../NafIndex.js":50,"../NetworkConnection.js":54,"../NetworkEntities.js":55,"../webrtc_interfaces/EasyRtcInterface.js":60}],59:[function(_dereq_,module,exports){
...
_dereq_('aframe-template-component');
_dereq_('aframe-lerp-component');

},{"./NafIndex.js":50,"./components/follow-camera.js":56,"./components/network-component.js":57,"./components/network-scene.js":58,"aframe-lerp-component":1,"aframe-template-component":2}],60:[function(_dereq_,module,exports){
var naf = _dereq_('../NafIndex.js');
...
},{"../NafIndex.js":50,"./WebRtcInterface.js":61}],61:[function(_dereq_,module,exports){
