...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NetworkEntities = function () {
	  ...
	  _createClass(NetworkEntities, [{
	    ...
	    key: 'newRemoteEntityCreatedEvent',
	    value: function newRemoteEntityCreatedEvent(el) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NetworkConnection = function () {
	  ...
	  _createClass(NetworkConnection, [{
	    ...
	    key: 'setupDefaultMessageSubs',
	    value: function setupDefaultMessageSubs() {
	      this.messageSubs = {};

	      this.messageSubs[ReservedMessage.Update] = this.entities.updateEntity.bind(this.entities);

	      this.messageSubs[ReservedMessage.Remove] = this.entities.removeRemoteEntity.bind(this.entities);
	    }
	  }, {
	    key: 'connect',
	    value: function connect(serverUrl, appName, roomName) {
	      ...
	      this.adapter.setMessageChannelListeners(this.messageChannelOpen.bind(this), this.messageChannelClosed.bind(this), this.receivedMessage.bind(this));
	    ...
	    value: function isMineAndConnected(client) {
	    ...
	    key: 'messageChannelOpen',
	    value: function messageChannelOpen(client) {
	    ...
	    key: 'messageChannelClosed',
	    value: function messageChannelClosed(client) {
	    ...
	    key: 'hasActiveMessageChannel',
	    value: function hasActiveMessageChannel(client) {
	      return this.activeMessageChannels.hasOwnProperty(client) && this.activeMessageChannels[client];
	    }
	  }, {
	    key: 'broadcastData',
	    value: function broadcastData(msgType, msg) {
	      this.adapter.broadcastData(msgType, msg);
	    }
	  }, {
	    key: 'broadcastDataGuaranteed',
	    value: function broadcastDataGuaranteed(msgType, msg) {
	      this.adapter.broadcastDataGuaranteed(msgType, msg);
	    }
	  }, {
	    key: 'sendData',
	    value: function sendData(toClient, msgType, msg, guaranteed) {
	    ...
	    value: function sendDataGuaranteed(toClient, msgType, msg) {
	      this.sendData(toClient, msgType, msg, true);
	    }
	  }, {
	    key: 'subscribeToMessage',
	    value: function subscribeToMessage(msgType, callback) {
	    ...
	    key: 'unsubscribeFromMessage',
	    value: function unsubscribeFromMessage(msgType) {
	      if (this.isReservedMessage(msgType)) {
	    ...
	    key: 'isReservedMessage',
	    value: function isReservedMessage(msgType) {
	      return msgType == ReservedMessage.Update || msgType == ReservedMessage.Remove;
	    }
	  }, {
	    key: 'receivedMessage',
	    value: function receivedMessage(fromClient, msgType, msg) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var INetworkAdapter = function (_NafInterface) {
	  ...
	  _createClass(INetworkAdapter, [{
	    ...
	    key: 'setMessageChannelListeners',
	    value: function setMessageChannelListeners(openListener, closedListener, messageListener) {
	      this.notImplemented();
	    }
	  }, {
	    key: 'connect',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EasyRtcAdapter = function (_INetworkAdapter) {
	  ...
	  _createClass(EasyRtcAdapter, [{
	    ...
	    value: function connectWithAudio(connectSuccess, connectFailure) {
	      var that = this;
