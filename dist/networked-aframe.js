...
/***/ (function(module, exports) {
	...
	module.exports.takeOwnership = function (entity) {
	  ...
	  var networkId = networkedEntity.getAttribute("networked").networkId;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ServerDate = __webpack_require__(66);
	...
	*/
	...
	var ServerDate = function (serverNow) {
	  ...
	  function setTarget(newTarget) {
	    ...
	    if (target) message += " (" + (newTarget > target ? "+" : "-") + " " + Math.abs(newTarget - target) + " ms)";
	  ...
	  function synchronize() {
	    ...
	    function requestSample() {
	      ...
	      request.onreadystatechange = function () {
	        ...
	        if (this.readyState == this.HEADERS_RECEIVED && this.status == 200) responseTime = Date.now();
	      };
	  ...
	  setInterval(function () {
	    ...
	    if (delta) log("Offset adjusted by " + delta + " ms to " + offset + " ms (target: " + target.value + " ms).");
	  }, 1000);
...
/***/ })
/******/ ]);
//# sourceMappingURL=networked-aframe.js.map